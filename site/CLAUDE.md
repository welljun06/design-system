...
- In immersive workflow detail pages, place the page title and back action on the left side with the conversation context. Do not reserve mirrored header content above the right artifact panel; let the right workspace start at the top edge with spacing only.
